...
public class ErrorResponse extends Object{
	...
	public static ErrorResponse COMPANY_ID_ERROR = new ErrorResponse("CompanyIDError", 8, 00, 45, "The Company ID in the Batch Header and Batch Control do not match");
	public static ErrorResponse BATCH_NUMBER_ERROR = new ErrorResponse("BatchNumberError", 8, 00, 88, "The Batch Number does not match in the Header and Control");
	...
	public static ErrorResponse BATCH_COUNT_ERROR = new ErrorResponse("BatchCountError", 9, 00, 1, "The number of Batches does not match the number in the File Control");
