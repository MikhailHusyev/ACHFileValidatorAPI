...
public class ValidationResponse extends Object{
	...
	public static ValidationResponse COMPANY_ID_ERROR = new ValidationResponse("CompanyIDError", 00, 00, 00, "The Company ID in the Batch Header and Batch Control do not match");
	public static ValidationResponse BATCH_NUMBER_ERROR = new ValidationResponse("BatchNumberError", 00, 00, 00, "The Batch Number does not match in the Header and Control");
	...
	public static ValidationResponse BATCH_COUNT_ERROR = new ValidationResponse("BatchCountError", 00, 00, 00, "The number of Batches does not match the number in the File Control");
	...
	public static ValidationResponse CLEAN_FILE_NO_ERROR = new ValidationResponse("CleanFileNoError", 00, 00, 00, "There were no errors found within the file");
